...
class AlienInvasion:
    ...
    def __init__(self):
        ...
        self.background_image =  pygame.image.load('images/background.jpeg').convert_alpha()
        self.ship = Ship(self)
    ...
    def _check_play_button(self,mouse_pos):
        """Start a new game when the plyaer clicks play."""
    ...
    def _update_aliens(self):
        """ check if the fleet is at edge of screen then update position."""
    ...
    def _change_fleet_direction(self):
        """Drop t he entire fleet and change the fleets direction."""
        for alien in self.aliens.sprites():
